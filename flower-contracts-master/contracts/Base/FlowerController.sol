...
contract FlowerController is IController, AccessControl, Ownable {
    ...
    modifier onlyOwnerOrPlatform() {
        require(owner() == msg.sender || hasRole(PLATFORM_ROLE, msg.sender), "no auth");
        _;
    }
    ...
    function updateModule(
        ...
        emit LogModuleUpdated(address(this), moduleName, proxy.implementation(), addr);
